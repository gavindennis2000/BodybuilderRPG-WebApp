...
const Home: React.FC = () => {
  ...
  // image tag styling for the home page
  const imgStyle = {
    margin: '10px'
  };

  return (
    <Paper square sx={{backgroundColor: 'rgb(26, 26, 26, 0.95)', marginTop: '20px', padding: '10px'}}>
        <Container sx={{marginTop: '10px'}}>
            <h1 style={{paddingBottom: '10px'}}>
              Welcome to the official website for Bodybuilder RPG!
            </h1>
            <p>
              Bodybuilder RPG is an upcoming indie game drawing inspiration from some of my favorite titles—Final Fantasy VII and X, The first generation Pokémon games, The Legend of Zelda series, Chrono Trigger, and Undertale.
            </p>
            <img src="/placeholder.jpg" alt="BBRPG Gameplay" style={imgStyle} />
            <p>
