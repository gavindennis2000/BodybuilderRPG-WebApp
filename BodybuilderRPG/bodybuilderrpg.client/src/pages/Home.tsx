  ...
  return (
    <Paper square sx={{backgroundColor: 'rgb(26, 26, 26, 0.9)', marginTop: '20px', padding: '10px'}}>
        <Container sx={{marginTop: '10px', marginBottom: '10px', width: '90%', textAlign: 'left'}}>
            ...
            <img src="/donnie battle.png" alt="BBRPG Battle System Gameplay" style={{width: '60%', height: 'auto', marginTop: '20px', marginBottom: '20px'}} />
            <p>
            ...
            <img src="/arnold cutscene.png" alt="BBRPG Overworld Cutscene" style={{width: '60%', height: 'auto', marginTop: '20px', marginBottom: '20px'}}/>
            <p>
